...
mpv --loop inf `find resources/tikot*.wav|sort -R|head -1` &

zenity --forms --text="Co děláte v případě nezaměstnanosti. Seřaďte následující úkony podle důležitosti. 1-7" \
...
--width=820 --height=480 >> priority.txt
